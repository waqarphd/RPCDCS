...
const string csFwSysStatManangementLibVersion = "1.2.6";
const string csFwSysStatManagementTool = "1.2.6";
...
int fwInstallationDB_unregisterGroupComponent(string componentName, string componentVersion, string groupName)
{
