...
@par Modification History
	...
	2011/03/21 Marco
  - Fix for bug #78859: filters for dpNames and aliases can now accept multiple items.
...
DebugN("s_deviceAlias: " + s_deviceAlias);
  fwGeneral_stringToDynString(s_deviceAlias,
						aesFilter[fwAlarmHandlingScreen_CONFIG_OBJECT_FILTER_DP_ALIAS], " ", FALSE, TRUE);
...
//   else
//   {
//     s_deviceNames = deviceName.text;
//     strrtrim(s_deviceNames);
//     strltrim(s_deviceNames);
//     strreplace(s_deviceNames, " " , " | ");    
//   }
  s_deviceNames = (deviceName.text=="") ? "*" : deviceName.text;
DebugN("s_deviceNames: " + s_deviceNames);
  fwGeneral_stringToDynString(s_deviceNames,
						aesFilter[fwAlarmHandlingScreen_CONFIG_OBJECT_FILTER_DP_NAME], " ", FALSE, TRUE);
