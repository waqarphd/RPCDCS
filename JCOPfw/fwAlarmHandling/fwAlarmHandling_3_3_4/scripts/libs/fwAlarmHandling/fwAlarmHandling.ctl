...
@par Modification History
	...
	- ENS-3073 (Alarm Screen with predefined quick filter): added new parameters, $iLocalOrGlobal, $sFilterName , new optional variable filterName in fwAlarmHandling_openScreenWithFilter()
