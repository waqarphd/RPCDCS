...
global string _fwConfigurationDB_fileVersion_fwConfigurationDB_ctl="3.5.7";
 ...
 * @ingroup Constants
*/
const float      fwConfigurationDB_minimalDBSchemaVersion=3.02;


const float     fwConfigurationDB_minimalRDBAccessVersion=1.50;
