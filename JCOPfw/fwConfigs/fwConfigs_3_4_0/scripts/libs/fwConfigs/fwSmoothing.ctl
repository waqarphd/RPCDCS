...
@par Modification History
  ...
  26/01/11  Marco
  - Fix for #77348, ENS-2495 - added option to archive or not the modification of smoothing (parametrization history).
                ...
                dyn_string &exceptionInfo, bool runDriverCheck = FALSE, bool storeInParamHistory = TRUE) 
{
	fwSmoothing_setMany(makeDynString(dpe), makeDynInt(smoothProcedure), makeDynFloat(deadband),
												makeDynFloat(timeInterval), exceptionInfo, runDriverCheck, storeInParamHistory);
} 
