...
string
  @par Usage
Optional. For discrete alarms only. Default value is "". Possible values: 1, 0 (ex: "11000000000000000000000001010101XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"). 
...
\code  
    fwAlertConfig_objectCreateAnalog(alarmObject,makeDynString("cool","warm","hot"),
                                     makeDynFloat(0,22,33), makeDynString("","_fwWarningAck.","_fwErrorAck."),
...
The object is set to the alarm using fwAlertConfig_objectSet
 ...
 \code  
    ...
    fwAlertConfig_objectCreateDiscrete(alarmObject,makeDynString("cool","warm","hot"),
                                     makeDynString("*","22,23","24-27"), makeDynString("","_fwWarningAck.","_fwErrorAck."),
                                     "panel.pnl", makeDynString("datapointForPanel1.value","datapointForPanel2.value"),
                                     "", false, makeDynBool(0,1,0), "11000000000000000000000001010101XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
                                     makeDynString("0010xxxxxxxxx0101011000000001000XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX","0010xxxxxxxxx0101011000000001000XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX","0010xxxxxxxxx0101011000000001000XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"),
                                     exc);
\endcode  
...
//       DebugN("dsSummaryDpeList: "+dsSummaryDpeList);
    ...
    //test to see if setting the type avoids the crashing...
//     dyn_string dsAlarmTypesAttr;
//     dyn_int diAlarmTypesVal, diAlarmTypesValNone;
//     int k;
//     for(k=1 ; k<=dynlen(attributes) ; k++)
//     {
//       if(patternMatch("*.._type", attributes[k]))
//       {
//         dynAppend(dsAlarmTypesAttr,attributes[k]);
//         dynAppend(diAlarmTypesVal,values[k]);
//         dynAppend(diAlarmTypesValNone,DPCONFIG_NONE);        
//         dynRemove(attributes,k);
//         dynRemove(values,k);
//         k--;
//       }
//     }
//     if(dynlen(dsAlarmTypesAttr))
//     {
//  DebugN("Resetting types...", bStoreInParamHistory, dsAlarmTypesAttr, diAlarmTypesValNone);
// 				dpSetWait(dsAlarmTypesAttr, diAlarmTypesValNone);
//  DebugN("Setting types...", bStoreInParamHistory, dsAlarmTypesAttr, diAlarmTypesVal);
// 			if(bStoreInParamHistory)
// 				dpSetWait(dsAlarmTypesAttr, diAlarmTypesVal);
// 			else
// 				dpSetTimedWait(0, dsAlarmTypesAttr, diAlarmTypesVal);   
//       dynClear(dsAlarmTypesAttr);   
//       dynClear(diAlarmTypesVal);   
//       dynClear(diAlarmTypesValNone);   
//     }
			//end of test
...
//    DebugN(stateBits);
  ...
  //WARNING: this piece of code is tremporarely disabled because of the bug on PVSS 3.8.2, as described on ETM-824
