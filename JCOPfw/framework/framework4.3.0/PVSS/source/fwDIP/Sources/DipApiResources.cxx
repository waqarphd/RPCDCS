...
void  DipApiResources::init(int &argc, char *argv[])
{
	...
	try {
		...
		if(true ==doNotLockDPEs) {
			...
			PVSSWARNING("The \"-no_dpe_locking\" flag was specified, do not lock DPEs mapped to DIP subscriptions (WARNING, no supported in production, will cause PVSS timestamp issues, c.f. DIP-44).");
		}
