-- Schema Upgrade script for the JCOP Framework ConfigurationDB Tool

-- the following DML statements need to be executed conditionally,
-- to compensate for the problems with half-updated schemas
-- due to bug #50248
--
begin
    DECLARE 
	...
	-- Check if a partial upgrade to schema 2.06 was succesful, i.e. 
	-- that CONFIG_GENERAL table was created.
	-- This means that we need to skip all the statements up to
	-- the part that creates the PL/SQL package
	
	select count(*) into cnt from user_tables where table_name='CONFIG_GENERAL' ;
	if ( cnt < 1) then
	    EXECUTE IMMEDIATE '
...
EXECUTE IMMEDIATE 'GRANT EXECUTE ON fwConfigurationDB TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON HIERARCHIES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON DEVICE_TYPES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON ITEMS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON RECIPES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON RECIPE_VERSIONS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON RECIPE_DATA TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON RECIPE_TAGS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON DEVICE_ELEMENTS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_ITEMS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_ITEM_PROPERTIES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_DESC TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_TAGS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON REFERENCES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_ADDRESSES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_ALERTS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_DPEALERTS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_SUMALERTS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_ALERTS_MISC TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_ARCHIVING TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_DPFUNCTIONS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_CONVERSIONS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_PVRANGES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_SMOOTHING TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_UF TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON CONFIG_GENERAL TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_ITEM_NAMES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_ITEMS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_RECIPESALL TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_REFERENCES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_CONFIG_ITEMS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_DEVICE_CONFIGS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_DEVICE_CONFIGS_ALL TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_ITEM_PROPERTIES TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT SELECT  ON V_CONFIG_ALERTS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT ALL  ON CDB_API_PARAMS TO PUBLIC';
EXECUTE IMMEDIATE 'GRANT ALL  ON TMP_ITEM_PROPS TO PUBLIC';
...
for cur in (select owner ow,constraint_name cn, constraint_type ct, table_name tn,search_condition sc
  ...
  if (cur.ct='C' AND substr(cc,-11)='IS NOT NULL' ) then
	...
	if newconstrname is null or newconstrname=cur.cn then
        dbms_output.put_line('SKIPPING:'||cur.tn||'.'||colname||' ('||cur.cn||')'||chr(10));
	else
