    ...
    fwDpFunction_objectInitialize(functionObject);
  	switch(dsTypesVal[i])
  	{
        ...
        functionObject[fwDpFunction_OBJ_TYPE] = dsTypesVal[i];//_type
      	functionObject[fwDpFunction_OBJ_PARAM] = dsAttrVal[j];j++;//_param
      	functionObject[fwDpFunction_OBJ_GLOBAL] = dsAttrVal[j];j++;//_global
      	functionObject[fwDpFunction_OBJ_FUNCTION] = dsAttrVal[j];j++;//_fct
      	functionObject[fwDpFunction_OBJ_STAT_TYPE] = dsAttrVal[j];j++;//_stat_type
      	functionObject[fwDpFunction_OBJ_STAT_INTERVAL] = dsAttrVal[j];j++;//_interval
      	functionObject[fwDpFunction_OBJ_STAT_DELAY] = dsAttrVal[j];j++;//_delay
      	functionObject[fwDpFunction_OBJ_STAT_READ_ARCHIVE] = dsAttrVal[j];j++;//_read_archive
  			break;
        ...
        functionObject[fwDpFunction_OBJ_TYPE] = dsTypesVal[i];//_type
      	functionObject[fwDpFunction_OBJ_PARAM] = dsAttrVal[j];j++;//_param
      	functionObject[fwDpFunction_OBJ_GLOBAL] = dsAttrVal[j];j++;//_fct
      	functionObject[fwDpFunction_OBJ_FUNCTION] = dsAttrVal[j];j++;//_global
  			break;
