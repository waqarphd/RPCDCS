...
{
void *cmd;
if(strstr(name_ptr,"GauchoJob_01"))
{
...
char *name;
name = getDimName();
if(strstr(getDimName(),"GauchoJob_01"))
{
DimManager::print_date_time_detailed();
cout << "Sent Command "<< getDimName() << " " << (char *)getWriteData() << " " << size << endl;
}
}
*/
...
/*
if(strstr(dpname,"GauchoJob_01"))
{
DimManager::print_date_time_detailed();
cout << "got "<< dpname << " = " << dpItem->getDPItemString() << endl;
}
*/
	if(isCmnd())
	{			
...
//			DISABLE_AST
			...
			if(dimItem->getTodoTypeFlag() == 1)
			{
				...
				{
//DimManager::print_date_time_detailed();
//cout << "Writing data for "<< obj->getDimName() << " " << obj->getNTypes() << endl;
					if(obj->write_data_differ())
						obj->clearWriteFlag();
					break_flag = 0;
					/* fix for ATLAS */
					n_done += obj->getNTypes();
...
//			cout << "Client service: " << dpe << " " << nItems << " " << dpsptr << " " << dpslen << endl;
//			TotClientServices += nItems;
//			cout << "Tot = " << TotClientServices << endl;
			break;
		case 1:
...
int own_system_flag = 0;
	...
	dim_set_read_buffer_size(512*1024);
	dim_set_write_buffer_size(65536);
	dim_init();
