...
private:
	...
	*/
	...
	/**
	 * DIP-96 : stores whether this particular mapping has already signaled
	 * a data conversion issue.
	 */
	bool m_alreadyReportedDataMappingProblem;
	
	/**
	 * DIP-96 : stores whether this particular mapping has already signaled
	 * a timestamp related issue.
	 */
	bool m_alreadyReportedTimestampProblem;
