/*------------------------------------------------------
   Mathias Dutour:
   Original file modified, see the corresponding header file for the details.
...
------------------------------------------------------*/
unsigned int CCmdLine::SplitLine(int argc, char **argv)
{
   clear();
...
unsigned int CCmdLine::GetArgumentCount(const char *pSwitch)
{
