...
See the full list of <a target=_blank href="https://icecontrols.cern.ch/jira/secure/IssueNavigator.jspa?reset=true&jqlQuery=project+%3D+FWCORE+AND+issuetype+in+standardIssueTypes%28%29+AND+status+%3D+resolved+and+fixVersion+is+not+null+ORDER+BY+fixVersion+DESC%2C+updated+DESC%2C+key+DESC">improvements and bug fixes</a>.
*/
