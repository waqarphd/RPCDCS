 ...
 */
global string _fwConfigurationDB_fileVersion_fwConfigurationDB_Recipes_ctl="5.0.2";
					...
					string mergeMode="")
{
    ...
    for (int i=fwConfigurationDB_RO_METAINFO_START;i<=fwConfigurationDB_RO_METAINFO_END;i++) {
      ...
      // ovewrite only if there is data present, and it is NOT NULL!
      if (dynlen(col) && getType(col[1])!=MIXED_VAR) recipeObject[i]=col;
