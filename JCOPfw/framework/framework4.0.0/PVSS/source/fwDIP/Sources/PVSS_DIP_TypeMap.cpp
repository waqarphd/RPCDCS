...
TMap::TMap(){
	if (dipToPvsstypeConverterList.size() == 0){
		...
		dipToPvsstypeConverterList[TYPE_BOOLEAN]		= new TConv(TYPE_BOOLEAN,		DPELEMENT_BIT,		dipBoolToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_BYTE]			= new TConv(TYPE_BYTE,			DPELEMENT_32BIT,	dipByteToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_SHORT]			= new TConv(TYPE_SHORT,			DPELEMENT_INT,		dipShortToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_INT]			= new TConv(TYPE_INT,			DPELEMENT_INT,		dipIntToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_LONG]			= new TConv(TYPE_LONG,			DPELEMENT_INT,		dipLongToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_FLOAT]			= new TConv(TYPE_FLOAT,			DPELEMENT_FLOAT,	dipFloatToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_DOUBLE]			= new TConv(TYPE_DOUBLE,		DPELEMENT_FLOAT,	dipDoubleToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_STRING]			= new TConv(TYPE_STRING,		DPELEMENT_TEXT,		dipStringToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_BOOLEAN_ARRAY]	= new TConv(TYPE_BOOLEAN_ARRAY,	DPELEMENT_DYNBIT,	dipBoolArrayToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_BYTE_ARRAY]		= new TConv(TYPE_BYTE_ARRAY,	DPELEMENT_DYN32BIT, dipByteArrayToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_SHORT_ARRAY]	= new TConv(TYPE_SHORT_ARRAY,	DPELEMENT_DYNINT,	dipShortArrayToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_INT_ARRAY]		= new TConv(TYPE_INT_ARRAY,		DPELEMENT_DYNINT,	dipIntArrayToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_LONG_ARRAY]		= new TConv(TYPE_LONG_ARRAY,	DPELEMENT_DYNINT,	dipLongArrayToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_FLOAT_ARRAY]	= new TConv(TYPE_FLOAT_ARRAY,	DPELEMENT_DYNFLOAT,	dipFloatArrayToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_DOUBLE_ARRAY]	= new TConv(TYPE_DOUBLE_ARRAY,	DPELEMENT_DYNFLOAT,	dipDoubleArrayToPVSSConverter);
		dipToPvsstypeConverterList[TYPE_STRING_ARRAY]	= new TConv(TYPE_STRING_ARRAY,	DPELEMENT_DYNTEXT,	dipStringArrayToPVSSConverter);
...
TConv *TMap::findDipToDpeConverterFor(const int dipType){
	TConv * typeConverter = dipToPvsstypeConverterList[dipType];
...
TConv *TMap::findDipToDpeConverterFor(const int dipType, const int dpeType){
	TConv * typeConverter = findDipToDpeConverterFor(dipType);
