...
#
# (c) Piotr Golonka, CERN IT/CO-BE, April 2005
# 
############################################################
...
#MANAGER=$PVSS_PROJ/bin/PVSS00dim3.6
MANAGER=$BIN_PATH/PVSS00dim3.8
...
RH9_LIB_PATH=$PVSS_II_PATH/bin

if  test ! -d $RH9_LIB_PATH  ; then
...
export LD_LIBRARY_PATH=$BIN_PATH:$RH9_LIB_PATH:$LD_LIBRARY_PATH
