...
global string _fwConfigurationDB_fileVersion_fwConfigurationDB_ctl="3.3.52";
 ...
 * @ingroup Constants
*/
const float      fwConfigurationDB_minimalDBSchemaVersion=2.05;


const float     fwConfigurationDB_minimalRDBAccessVersion=0.45;
