...
PVSS manager usage: CTRL (PVSS00CTRL), UI (PVSS00NV) and UI extended (PVSS00NG)
...
get the config of all the declared _UnDistribtuedControl. empty field or 0 means default value.
	...
	@param diPortNumber: dyn_int, output, list of all the port number of the PVSS00dist of the declared _UnDistribtuedControl
...
set the config of all the _UnDistribtuedControl_systemName. empty field or 0 means default value.
	...
	@param iPortNumber: int, input, the port number of the PVSS00dist of the declared _UnDistribtuedControl
