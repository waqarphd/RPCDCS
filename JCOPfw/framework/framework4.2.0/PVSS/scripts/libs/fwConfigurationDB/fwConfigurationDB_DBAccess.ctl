...
global string _fwConfigurationDB_fileVersion_fwConfigurationDB_DBAccess_ctl="3.3.63";
...
void fwConfigurationDB_executeSqlSimple(string sql, dbConnection connection,dyn_string &exceptionInfo)
{
    ...
    if (rc<0) {
	fwException_raise(exceptionInfo,"ERROR in fwConfigurationDB_executeSqlSimple","Cannot execute SQL Statement - invalid dbConnection","");
	return;
    } else if (rc==1){
	string errTxt;
