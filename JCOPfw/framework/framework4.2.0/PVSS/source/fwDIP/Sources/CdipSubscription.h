...
private:
	...
	*/
	DipApiManager & apiManager;
		...
		*/
		void addMappedDPEValueInformationToUpdateList(DpIdValueList & list, DipData& data, DipLong timestampToUseForPVSS, superlong originalDipTimestamp, bool setCorrectionValueAsInvalid, bool indicateTimeSourceDiscrepancy);
