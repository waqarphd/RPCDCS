/*------------------------------------------------------
   Mathias Dutour: Original source code modified: 
   - Cleaned MFC support.
   - Removed suppressed warning checks and fixed them.
   - Removed irrelevant comments.
   - Adapted preprocessor declarations.
...
typedef map<string, CCmdParam > CCmdLineMap;

// the command line parser class
class CCmdLine : public CCmdLineMap
{
...
public:
   ...
   ------------------------------------------------------*/
   unsigned int SplitLine(int argc, char **argv);
   ...
   ------------------------------------------------------*/
   unsigned int GetArgumentCount(const char *pSwitch);
